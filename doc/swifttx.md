...
This mechanism has been integrated into Bitcore-Node-LUK which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/LUK-Project/insight-api-luckycoin#web-socket-api](https://github.com/LUK-Project/insight-api-luckycoin#web-socket-api) 
* API: [https://github.com/LUK-Project/insight-api-luckycoin#swifttx-transactions](https://github.com/LUK-Project/insight-api-luckycoin#swifttx-transactions) 
...
By default, the LUK Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the LUK Core daemon:
