...
In order to support loading of multiple wallets in luckycoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is luckycoin.cpp.
...
Changes to luckycoin.cpp
----------------------
luckycoin.cpp is the entry point into luckycoin-qt, and as such, will require some minor modifications to provide hooks for
