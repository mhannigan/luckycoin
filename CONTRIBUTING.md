Contributing to LUK Core
============================

The LUK Core project operates an open contributor model where anyone is
...
The following applies to code changes to the LUK Core project, and is not to be
confused with overall LUK Network Protocol consensus changes.

Whether a pull request is merged into LUK Core rests with the project merge
...
Patches that change LUK consensus rules are considerably more involved than
...
Where a patch set proposes to change the LUK consensus, it must have been
...
The project leader is the release manager for each LUK Core release.
