...
#ifndef LUK_ZLUKWALLET_H
#define LUK_ZLUKWALLET_H
...
public:
    CzLUKWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZLUK(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZLUK(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //LUK_ZLUKWALLET_H
