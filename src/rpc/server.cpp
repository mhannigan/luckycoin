...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* LUK features */
        {"luckycoin", "masternode", &masternode, true, true, false},
        {"luckycoin", "listmasternodes", &listmasternodes, true, true, false},
        {"luckycoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"luckycoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"luckycoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"luckycoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"luckycoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"luckycoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"luckycoin", "masternodedebug", &masternodedebug, true, true, false},
        {"luckycoin", "startmasternode", &startmasternode, true, true, false},
        {"luckycoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"luckycoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"luckycoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"luckycoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"luckycoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"luckycoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"luckycoin", "mnbudget", &mnbudget, true, true, false},
        {"luckycoin", "preparebudget", &preparebudget, true, true, false},
        {"luckycoin", "submitbudget", &submitbudget, true, true, false},
        {"luckycoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"luckycoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"luckycoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"luckycoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"luckycoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"luckycoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"luckycoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"luckycoin", "checkbudgets", &checkbudgets, true, true, false},
        {"luckycoin", "mnsync", &mnsync, true, true, false},
        {"luckycoin", "spork", &spork, true, true, false},
        {"luckycoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> luckycoin-cli " + methodname + " " + args + "\n";
}
