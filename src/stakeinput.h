...
#ifndef LUK_STAKEINPUT_H
#define LUK_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZLUK() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zLUKStake can take two forms
...
public:
    ...
    bool IsZLUK() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZLUK() override { return false; }
};


#endif //LUK_STAKEINPUT_H
