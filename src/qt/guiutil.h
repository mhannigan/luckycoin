...
/** Utility functions used by the LUK Qt UI.
 */
namespace GUIUtil
{
...
// Render LUK addresses in monospace font
...
// Parse "luckycoin:" URI into recipient object, return true on successful parsing
