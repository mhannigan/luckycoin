                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("LUK Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LUK address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and luckycoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zLUK"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About LUK Core"), this);
    aboutAction->setStatusTip(tr("Show information about LUK Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LUK"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LUK addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LUK addresses"));
    ...
    openAction->setStatusTip(tr("Open a LUK: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LUK Core help message to get a list with possible LUK command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("LUK Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LUK network", "", count));
}
...
{
    QString strTitle = tr("LUK Core"); // default title
