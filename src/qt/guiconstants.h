...
/* LuckyCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "LUK"
#define QAPP_ORG_DOMAIN "luckycoin.org"
#define QAPP_APP_NAME_DEFAULT "LUK-Qt"
#define QAPP_APP_NAME_TESTNET "LUK-Qt-testnet"
